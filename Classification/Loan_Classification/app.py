...
<style>
    ...
    label p {
        ...
        font-weight: 600 !important; /* Koncham boldu ga kanipisthayi */
    }
    
    /* Expander label (Summary text) ni clear ga dikhithe la cheyadaniki */
    .streamlit-expanderHeader p {
        color: #1F4E79 !important; /* Dark Blue */
    ...
    /* View Full Applicant Summary text ni dark color loki marchadaniki */
    .stDetails summary p {
        color: #1F4E79 !important; /* Dark Blue color */
        font-weight: 600 !important;
        font-size: 1.1rem !important;
    }

    /* Expander arrow (pakkana unna arrow) color */
